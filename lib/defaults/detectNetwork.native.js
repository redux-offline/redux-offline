...
var DetectNetwork = function () {
  function DetectNetwork(callback) {
    ...
    this._hasChanged = function (reach) {
    ...
    this._setReach = function (reach) {
      _this._reach = reach;
      _this._isConnected = _this._getConnection(reach);
    };

    this._getConnection = function (reach) {
      return reach !== 'NONE' && reach !== 'UNKNOWN';
    };

    this._setIsConnectionExpensive = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    ...
    this._init = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
      var reach;
    ...
    this._dispatch = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
